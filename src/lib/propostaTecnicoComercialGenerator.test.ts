...
describe('Proposta Técnico-Comercial Generator', () => {
  const dadosExemplo: PropostaTecnicoComercialDados = {
    ...
    producao: {
      ...
      mediaMensalKwh: 1250,
      geracaoMensal: [
        { mesNome: 'Jan', mesIndex: 0, dias: 31, irradiacaoHSP: 5.65, fatorSazonal: 1.1, geracaoKwh: 1400 },
        { mesNome: 'Fev', mesIndex: 1, dias: 28, irradiacaoHSP: 5.35, fatorSazonal: 1.0, geracaoKwh: 1300 },
        { mesNome: 'Mar', mesIndex: 2, dias: 31, irradiacaoHSP: 4.8, fatorSazonal: 1.0, geracaoKwh: 1250 },
        { mesNome: 'Abr', mesIndex: 3, dias: 30, irradiacaoHSP: 4.05, fatorSazonal: 0.9, geracaoKwh: 1100 },
        { mesNome: 'Mai', mesIndex: 4, dias: 31, irradiacaoHSP: 3.25, fatorSazonal: 0.7, geracaoKwh: 900 },
        { mesNome: 'Jun', mesIndex: 5, dias: 30, irradiacaoHSP: 2.95, fatorSazonal: 0.68, geracaoKwh: 850 },
        { mesNome: 'Jul', mesIndex: 6, dias: 31, irradiacaoHSP: 3.15, fatorSazonal: 0.73, geracaoKwh: 920 },
        { mesNome: 'Ago', mesIndex: 7, dias: 31, irradiacaoHSP: 3.9, fatorSazonal: 0.84, geracaoKwh: 1050 },
        { mesNome: 'Set', mesIndex: 8, dias: 30, irradiacaoHSP: 4.25, fatorSazonal: 0.92, geracaoKwh: 1150 },
        { mesNome: 'Out', mesIndex: 9, dias: 31, irradiacaoHSP: 4.95, fatorSazonal: 1.04, geracaoKwh: 1300 },
        { mesNome: 'Nov', mesIndex: 10, dias: 30, irradiacaoHSP: 5.6, fatorSazonal: 1.12, geracaoKwh: 1400 },
        { mesNome: 'Dez', mesIndex: 11, dias: 31, irradiacaoHSP: 5.85, fatorSazonal: 1.16, geracaoKwh: 1450 },
      ],
    },
    economia: {
