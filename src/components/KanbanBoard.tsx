...
export const KanbanBoard: React.FC<KanbanBoardProps> = ({ clientes: clientesProp }) => {
  ...
  // O funil de vendas Kanban exibe apenas etapas ativas do negócio — negócios Perdidos e Arquivados saem do funil
  const clientes = clientesProp.filter((c) => (c.status as string) !== 'Perdido' && !c.arquivado)
