...
export function useClientes(): ClientesContextType {
  ...
  if (!context) {
    ...
    return {
      ...
      selectedClienteProjeto: null,
      selectedContratoOM: null,
      activeClientTab: 'historico',
      selectedOMClienteId: null,
      openFichaOM: () => {},
      closeFichaOM: () => {},
      setActiveClientTab: () => {},
      openFichaCliente: () => {},
      ...
      addAtividade: async () => ({}) as any,
      updateAtividade: async () => ({}) as any,
      ...
      updateProfissional: async () => ({}) as any,
      removeProfissional: async () => {},
      addProjeto: async () => ({}) as any,
      ...
      removeContratoOM: async () => {},
      encerrarContratoOM: async () => ({}) as any,
      renovarContratoOM: async () => ({}) as any,
      addAnomaliaOM: async () => ({}) as any,
      updateAnomaliaOM: async () => ({}) as any,
      removeAnomaliaOM: async () => {},
      addServicoAdicionalOM: async () => ({}) as any,
      updateServicoAdicionalOM: async () => ({}) as any,
      removeServicoAdicionalOM: async () => {},
      addServicoAvulso: async () => ({}) as any,
      updateServicoAvulso: async () => ({}) as any,
      removeServicoAvulso: async () => {},
      addTransferenciaCredito: async () => ({}) as any,
      updateTransferenciaCredito: async () => ({}) as any,
      removeTransferenciaCredito: async () => {},
      refreshTransferenciasCreditos: async () => {},
      addOrUpdateDocumentoCliente: async () => ({}) as any,
      getDocumentoCliente: () => undefined,
      updateDocumentoClienteStatus: async () => ({}) as any,
      removeDocumentoCliente: async () => {},
      refreshDocumentosCliente: async () => {},
      addTimelineOM: async () => ({}) as any,
      addPropostaOM: async () => ({}) as any,
      updatePropostaOM: async () => ({}) as any,
      removePropostaOM: async () => {},
      addOrcamentoSolar: async () => ({}) as any,
      updateOrcamentoSolar: async () => ({}) as any,
      removeOrcamentoSolar: async () => {},
      addFornecedor: async () => ({}) as any,
      updateFornecedor: async () => ({}) as any,
      removeFornecedor: async () => {},
      addFornecedorOrcamento: async () => ({}) as any,
      updateFornecedorOrcamento: async () => ({}) as any,
      selecionarFornecedorOrcamento: async () => ({}) as any,
      removeFornecedorOrcamento: async () => {},
      refreshFornecedores: async () => {},
      addWhatsAppTemplate: async () => ({}) as any,
      updateWhatsAppTemplate: async () => ({}) as any,
      removeWhatsAppTemplate: async () => {},
      vincularConversa: async () => ({}) as any,
      assumirAtendimento: async () => ({}) as any,
      finalizarAtendimento: async () => ({}) as any,
